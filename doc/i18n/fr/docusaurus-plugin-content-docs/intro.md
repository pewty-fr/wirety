...
Bienvenue sur Wirety : un maillage WireGuard sécurisé et dynamique avec automatisation basée sur agents, réponse aux incidents pilotée par ACL, et types de peers flexibles.
...
| WireGuard installé | Pour les peers statiques (téléphones, ordinateurs) | Conditionnel |
